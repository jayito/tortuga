  ...
  return (
   <section className="page-section bg-primary text-blue mb-0" id="about">
        <Container>
            ...
            <div className="row" style={{marginLeft: 'auto !important'}}>
                <p className="lead">Welcome to $TORTUGA, the famous Pirates island in the Caribbean where the TREASURE is SHARED by all the pirates who join one of the first democratic system. This system is spelled out by written “articles of agreement,” to limit the captain's power and to keep order on board the ship.</p>
