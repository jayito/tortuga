...
const Header = () => {
  return (
    <header className="masthead bg-primary text-blue text-center" id="header" style={{ marginTop: "-150px"}}>
        ...
        <div className="container d-flex align-items-center flex-column" >
            ...
            <p className="masthead-subheading font-weight-light mb-0" style={{wordBreak: "break-all"}}>0xaB2712b217F0015B602C06E4fb66B8cf8B04F894</p>
        </div>
